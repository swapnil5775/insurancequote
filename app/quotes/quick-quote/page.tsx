      ...
      <div className="bg-blue-600 py-12">
        <div className="container mx-auto px-4">
          <div className="text-center text-white mb-8">
            <h1 className="text-4xl font-bold mb-4">GET A QUICK QUOTE</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-gray-50 p-8 rounded-lg shadow-sm">
            <form className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-blue-800 mb-6">Personal Information</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-blue-800 mb-6">Insurance Needs</h2>
              ...
              <div className="flex items-center space-x-2">
                ...
                <label htmlFor="consent" className="text-sm">
                  I consent to being contacted by Bright Harbor Insurance regarding my insurance needs.
                </label>
              </div>
      ...
      <div className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-blue-800 mb-6 text-center">What Happens Next?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p>Our team will carefully review your information to understand your needs.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p>An insurance expert will reach out to discuss your options and answer questions.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p>We'll help you select and implement the perfect insurance solution.</p>
              </div>
            </div>
          </div>
        </div>
