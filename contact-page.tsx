      ...
      <div className="relative w-full h-[300px] bg-blue-600">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6 text-center">
          ...
          <p className="text-xl max-w-2xl">
            If you have any questions or are in need of assistance, feel free to give us a call!
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 bg-white p-8 rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold text-blue-800 mb-6 text-center">WE ARE HERE FOR YOU</h2>
          ...
          <div className="bg-blue-500 text-white p-8 rounded-lg">
            ...
            <div className="space-y-6 mt-8">
              <div className="text-center">
                <h3 className="text-xl font-bold mb-4">BRIGHT HARBOR INSURANCE, INC.</h3>

                <div className="flex items-center justify-center mb-2">
                  <MapPin className="mr-2" size={18} />
                  <p>7637 N. 56th St</p>
                </div>
                <p className="mb-4">Tampa, FL 33617</p>
